...
export const ModalSidebar = memo(function ModalSidebar({ className }: ModalSidebarProps) {
  return (
    <aside
      className={cn(
        "relative hidden overflow-hidden rounded-[24px] border border-orange-500/15 bg-gradient-to-br from-[#1a0900] via-[#120600] to-[#040200] p-8 lg:flex lg:flex-col lg:justify-between",
        className,
      )}
    >
      ...
      <div className="relative">
        ...
        <div className="mt-8 rounded-[20px] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-sm">
          <div className="flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-amber-400 text-lg font-bold text-black shadow-[0_0_30px_-8px_rgba(255,140,0,0.8)]">
            NV
          </div>
